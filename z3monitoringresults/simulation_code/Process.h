...
*/
struct message{
	message(int arrival_time, const HVC& sender_at,const HLC& lsender_at, int sender_id) : arrival_time(arrival_time), sender_at(sender_at),lsender_at(lsender_at), sender_id(sender_id){}
