...
int main(int argc, char* argv[]) {
   	...
   	for(int i = 0; i < num_of_runs; i++)
	{
		...
		ofstream wcp_predicate("wcp_predicate_a"+std::to_string(alpha)+"_e"+std::to_string(epsilon)+"_l"+std::to_string(localPredRate)+"_d"+std::to_string(delta)+"_v"+std::to_string(glob_true_interval)+"_run"+std::to_string(i)+".smt2",ios::out | ios::app);
		...
		/************code for predicate printing***********/
		ofstream wcp_predicate_1("wcp_predicate_a"+std::to_string(alpha)+"_e"+std::to_string(epsilon)+"_l"+std::to_string(localPredRate)+"_d"+std::to_string(delta)+"_v"+std::to_string(glob_true_interval)+"_run"+std::to_string(i)+".smt2",ios::out | ios::app);
		//wcp_predicate.open("wcp_predicate.smt2",ios::out | ios::app);
